...
?>
						 ...
						 <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Buradan T.C. kimlik numarası ile <code>Eokul Belge</code> sorgusu yapabilirsiniz</p>    
    ...
    <tbody>
		...
		$json = json_decode($istek, true)["AldigiBelgeler"];
        ...
        ?>
            ...
            <tr>
                <td> <?php echo $tc; ?> </td>
				<td> <?php echo isset($data['Sinifi']) ? $data['Sinifi'] : "-"; ?></td>
				<td> <?php echo isset($data['Donemi']) ? $data['Donemi'] : "-"; ?></td>
				<td> <?php echo isset($data['BelgeTuru']) ? $data['BelgeTuru'] : "-"; ?></td>
