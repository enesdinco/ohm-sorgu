...
?>
						 ...
						 <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Buradan T.C. kimlik numarası ile <code>Yıl Sonu Not</code> sorgusu yapabilirsiniz</p>    
    ...
    <tbody>
		...
		$json = json_decode($istek, true)["YilSonuNotlari"];
        ...
        ?>
            ...
            <tr>
                <td> <?php echo $tc; ?> </td>
				<td> <?php echo isset($data['SINIF']) ? $data['SINIF'] : "-"; ?></td>
				<td> <?php echo isset($data['OGRETIMYILI']) ? $data['OGRETIMYILI'] : "-"; ?></td>
				<td> <?php echo isset($data['YILSONUNOTU']) ? $data['YILSONUNOTU'] : "-"; ?></td>
