...
?>
						 ...
						 <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Buradan T.C. kimlik numarası ile <code>Eokul Numarası</code> sorgusu yapabilirsiniz</p>    
    ...
    <tbody>
        ...
        ?>
            ...
            <tr>
                <td> <?php echo $tc; ?> </td>
				<td> <?php echo isset($data['ad']) ? $data['ad'] : "-"; ?></td>
                <td> <?php echo isset($data['soyad']) ? $data['soyad'] : "-"; ?></td>
				<td> <?php echo isset($data['okulno']) ? $data['okulno'] : "-"; ?></td>
