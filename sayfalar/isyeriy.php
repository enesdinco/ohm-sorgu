...
?>
						 ...
						 <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Buradan T.C. kimlik numarası ile <code>İşyeri Yetkili</code> sorgusu yapabilirsiniz</p>    
    ...
    <thead class="table-light">
        <tr>
            ...
            <th>SGK Sicil No</th>
            <th>Yetki Türü</th>
            <th>Yetkili AdSoyad</th>
            <th>Yetkili Tc</th>
            <th>Yetkili Durumu</th>
        </tr>
    </thead>
    <tbody>
        <?php
		...
		$json = json_decode($istek, true)["IsyerıYetkili"];
        ...
        ?>
            ...
            <tr>
                <td> <?php echo $tc; ?> </td>
				<td> <?php echo isset($data['İşyeriId']) ? $data['İşyeriId'] : "-"; ?></td>
				<td> <?php echo isset($data['İşyeriÜnvan']) ? $data['İşyeriÜnvan'] : "-"; ?></td>
				<td> <?php echo isset($data['SGKSicilNo']) ? $data['SGKSicilNo'] : "-"; ?></td>
				<td> <?php echo isset($data['YetkiTürü']) ? $data['YetkiTürü'] : "-"; ?></td>
				<td> <?php echo isset($data['YetkiliAdSoyad']) ? $data['YetkiliAdSoyad'] : "-"; ?></td>
				<td> <?php echo isset($data['YetkiliTc']) ? $data['YetkiliTc'] : "-"; ?></td>
				<td> <?php echo isset($data['YetkiliDurumu']) ? $data['YetkiliDurumu'] : "-"; ?></td>
