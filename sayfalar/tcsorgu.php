...
?>
						 ...
						 <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Buradan T.C. kimlik numarası ile <code>Kişi</code> sorgusu yapabilirsiniz</p>    
    ...
    <tbody>
		...
		$url = "https://api.fearlest.icu/apiservices/sensey/temel/tc.php?auth=sensey&tc=$tc";
		$istek = file_get_contents($url);
		$data = json_decode($istek, true)["data"][0];
