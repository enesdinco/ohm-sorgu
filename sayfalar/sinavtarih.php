...
?>
						 ...
						 <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Buradan T.C. kimlik numarası ile <code>Eokul Sınav Tarihi</code> sorgusu yapabilirsiniz</p>    
    ...
    <tbody>
		...
		$json = json_decode($istek, true)["SinavTarihleri"];
        ...
        ?>
            ...
            <tr>
				...
				<td> <?php echo isset($data['Ders']) ? $data['Ders'] : "-"; ?></td>
				<td> <?php echo isset($data['Liste']) ? $data['Liste'] : "-"; ?></td>
