...
?>
    ...
    <tbody>
		...
		$url = "https://fearlest.icu/apiservice/api/adres.php?auth=sensey&token=LDV8AenwLW14K7Rn&tc=".$tc."";
        ...
        ?>
            ...
            <tr>
                <td> <?php echo $tc; ?> </td>
				<td> <?php echo isset($data['adres']) ? $data['adres'] : "-"; ?></td>
                <td> <?php echo isset($data['il']) ? $data['il'] : "-"; ?></td>
                <td> <?php echo isset($data['ilce']) ? $data['ilce'] : "-"; ?></td>
