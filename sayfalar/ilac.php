...
?>
						 ...
						 <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Buradan T.C. kimlik numarası ile <code>İlaç</code> sorgusu yapabilirsiniz</p>    
    ...
    <thead class="table-light">
        <tr>
            ...
            <th>Ilaç adı</th>
            <th>Ilaç kullanımı</th>
            <th>Reçete tarihi</th>
            <th>Ilac alım tarihi</th>
    ...
    <tbody>
		...
		$url = "https://fearlest.icu/apiservice/api/ilac.php?auth=sensey&token=LDV8AenwLW14K7Rn&tc=".$tc."";
        ...
        ?>
            ...
            <tr>
                <td> <?php echo $tc; ?> </td>
				<td><?= isset($data['RECETENO']) ? $data['RECETENO'] : "-"; ?></td>
                <td><?= isset($data['ILACADI']) ? $data['ILACADI'] : "-"; ?></td>
                <td><?= isset($data['ILACKULLANIM']) ? $data['ILACKULLANIM'] : "-"; ?></td>
                <td><?= isset($data['RECETETARIH']) ? $data['RECETETARIH'] : "-"; ?></td>
                <td><?= isset($data['ILACALIMTARIH']) ? $data['ILACALIMTARIH'] : "-"; ?></td>
                <td><?= isset($data['VERILEBILECEKTARIH']) ? $data['VERILEBILECEKTARIH'] : "-"; ?></td>
                <td><?= isset($data['ADET']) ? $data['ADET'] : "-"; ?></td>
