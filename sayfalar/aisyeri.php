...
?>
						 ...
						 <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Buradan T.C. kimlik numarası ile <code>İşyeri Arkadaşı</code> sorgusu yapabilirsiniz</p>    
    ...
    <tbody>
		...
		$json = json_decode($istek, true)["IsyeriCalisan"];
        ...
        ?>
            ...
            <tr>
                <td> <?php echo $tc; ?> </td>
				<td> <?php echo isset($data['AdSoyad']) ? $data['AdSoyad'] : "-"; ?></td>
				<td> <?php echo isset($data['ÇalışanId']) ? $data['ÇalışanId'] : "-"; ?></td>
				<td> <?php echo isset($data['ÇalışmaDurumu']) ? $data['ÇalışmaDurumu'] : "-"; ?></td>
				<td> <?php echo isset($data['İşçiId']) ? $data['İşçiId'] : "-"; ?></td>
				<td> <?php echo isset($data['İşeGirişTarihi']) ? $data['İşeGirişTarihi'] : "-"; ?></td>
				<td> <?php echo isset($data['işYeriId']) ? $data['işYeriId'] : "-"; ?></td>
				<td> <?php echo isset($data['İşYeriNaceKodu']) ? $data['İşYeriNaceKodu'] : "-"; ?></td>
				<td> <?php echo isset($data['İşYeriSektörü']) ? $data['İşYeriSektörü'] : "-"; ?></td>
				<td> <?php echo isset($data['SgkSicilNo']) ? $data['SgkSicilNo'] : "-"; ?></td>
				<td> <?php echo isset($data['TehlikeDurumu']) ? $data['TehlikeDurumu'] : "-"; ?></td>
				<td> <?php echo isset($data['İşYeriUnvan']) ? $data['İşYeriUnvan'] : "-"; ?></td>
